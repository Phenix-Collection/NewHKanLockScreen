 ...
 */
public class CV_LockInit_ManualSetItems_4 extends CV_LockInit_ManualSetItemsBase implements View.OnClickListener {
    ...
    public CV_LockInit_ManualSetItems_4(Context context) {
        this(context, null);
    }

    public CV_LockInit_ManualSetItems_4(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CV_LockInit_ManualSetItems_4(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            case R.id.tv_manualset_autostart:
                try{
                    ...
                    ComponentName componentName = new ComponentName("com.gionee.softmanager"
                            , "com.gionee.softmanager.softmanager.SoftManagerActivity");
