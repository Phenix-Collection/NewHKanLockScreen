 ...
 */
public class ManualSetItems_5 extends CV_LockInit_ManualSetItemsBase implements View.OnClickListener {
    ...
    public ManualSetItems_5(Context context) {
        this(context, null);
    }

    public ManualSetItems_5(Context context, @Nullable AttributeSet attrs) {
        ...
        switch (v.getId()) {
            case R.id.tv_manualset_autostart:
                try{
                    ...
                    ComponentName componentName = new ComponentName("com.samsung.android.sm_cn"
                    ...
                    App.sMainHanlder.post(new Runnable() {
                        @Override
                        public void run() {
                            Intent i2 = new Intent(mContext, ActivityPrompt_AutoStart_5.class);
