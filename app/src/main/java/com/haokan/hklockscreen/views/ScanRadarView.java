package com.haokan.hklockscreen.views;
...
public class ScanRadarView extends View {
    ...
    public ScanRadarView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ScanRadarView(Context context, AttributeSet attrs, int defStyleAttr) {
