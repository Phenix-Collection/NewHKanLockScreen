 ...
 */
public class RequestHeader_FaGe<RequestBody> {
    /**
     ...
     * @param body 请求体
     */
    public RequestHeader_FaGe(RequestBody body) {
...
//        LogHelper.e("times","before---bodyStr="+bodyStr);
        ...
        //sign： timeStamp+imei+companyId   md5加密后的值放入sign
        String sign_temp = sb.append(timeStamp).append(imei).append(companyId).toString();
